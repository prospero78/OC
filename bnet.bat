...
echo 6. Compile modTagger.dll
vbc source\modTagger.vb /nologo /debug+ /optionexplicit+ /optioninfer+ /optionstrict+ /rootnamespace:nsOc /platform:x86 /utf8output+ /r:"modFile.dll" /out:"modTagger.dll" /t:library /optimize+
...
vbc source\modCompiler.vb /nologo /debug+ /optionexplicit+ /optioninfer+ /optionstrict+ /rootnamespace:nsOc /platform:x86 /utf8output+ /r:"modTagger.dll" /r:"modFile.dll" /r:"modCocon.dll" /t:library /out:"modCompiler.dll" /optimize+
