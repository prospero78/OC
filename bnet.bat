...
echo 9. Compile modType.dll
vbc source\modType.vb /nologo /debug+ /optionexplicit+ /optioninfer+ /optionstrict+ /rootnamespace:nsOc /platform:x86 /utf8output+ /r:"bin\modTagger.dll" /r:"bin\modUtil.dll" /r:"bin\modCocon.dll" /r:"bin\modFile.dll" /r:"bin\modConst.dll" /t:library /out:"bin\modType.dll" /optimize+

echo 10. Compile modLexer.dll
...
echo 11. Compile modCompiler.dll
