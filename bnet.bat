...
vbc source\modCompiler.vb /nologo /debug+ /optionexplicit+ /optioninfer+ /optionstrict+ /rootnamespace:nsOc /platform:x86 /utf8output+ /r:"bin\modConst.dll" /r:"bin\modUtil.dll" /r:"bin\modTagger.dll" /r:"bin\modFile.dll" /r:"bin\modCocon.dll" /t:library /out:"bin\modCompiler.dll" /optimize+
