...
' MODULE ORB;
Public Module ORB
   ' (*NW 25.6.2014  / 17.9.2016  in Oberon-07*)
...
' CONST
   'versionkey* = 1;
   Public Const versionkey As Integer = 1
   'maxTypTab = 64;
   Const maxTypTab As Integer = 64
   ' (* class values*) Head* = 0;
   Public Const Head As Integer = 0
   ' Const* = 1;
   Public Const Const_ As Integer = 1
   'Var* = 2;
   Public Const Var As Integer = 2
   'Par* = 3;
   Public Const Par As Integer = 3
   'Fld* = 4;
   Public Const Fld As Integer = 4
   'Typ* = 5;
   Public Const Typ As Integer = 5
   ' SProc* = 6;
   Public Const SProc As Integer = 6
   'SFunc* = 7;
   Public Const SFunc As Integer = 7
   'Mod* = 8;
   Public Const Mod_ As Integer = 8

   ' (* form values*)
      ' Byte* = 1;
      Public Const Byte_ As Integer = 1
      'Bool* = 2;
      Public Const Bool As Integer = 2
      'Char* = 3;
      Public Const Char_ As Integer = 3
      'Int* = 4;
      Public Const Int As Integer = 4
      'Real* = 5;
      Public Const Real As Integer = 5
      'Set* = 6;
      Public Const Set_ As Integer = 6
      ' Pointer* = 7;
      Public Const Pointer As Integer = 7
      'NilTyp* = 8;
      Public Const NilTyp As Integer = 8
      'NoTyp* = 9;
      Public Const NoTyp As Integer = 9
      'Proc* = 10;
      Public Const Proc As Integer = 10
      ' String* = 11;
      Public Const String_ As Integer = 11
      'Array* = 12;
      Public Const Array As Integer = 12
      'Record* = 13;
      Public Const Record As Integer = 13
...
' TYPE 
   ...
   Public Class ObjDesc
      ' ObjDesc*= RECORD
         ...
         ' val*: LONGINT
       ' END ;
      Public class_ As Integer
      Public lev As Integer
      Public expo As Boolean 'exported
      Public rdo As Boolean  'read-only
      Public next_ As clsObject
      Public dsc   As clsObject
      Public type_ As clsType
      Public name As ORS.Ident
      Public val as Long
      End Class
